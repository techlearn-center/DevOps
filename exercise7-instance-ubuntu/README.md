...
2. **Setting Up Jenkins:**
   - To set up Jenkins and Maven, copy the content of `ec2-install-jenkins.txt` (this has maven installation scriptas well) into the `ec2-instance.tf` file within the Jenkins directory.
